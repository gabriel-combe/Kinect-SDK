//Copyright 2017 Maxime Coutté-Péroumal Corne. All rights reserved. Original work Google Inc.
//
...
#if !UNITY_HAS_GOOGLEVR || (UNITY_EDITOR || UNITY_STANDALONE && (UNITY_ANDROID || UNITY_IOS))
